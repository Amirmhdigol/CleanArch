...
using CleanArch.Domain.Test.Unit.Builders;
using FluentAssertions;
using System;
using Xunit;

namespace CleanArch.Domain.Test.Unit
{
    public class ProductTests
    {
        ...
        {
            //arrange
            _productBuilder.SetTitle("test2");
        ...
        public void Edit_Should_Update_Product_When_Data_Is_Ok()
        {
            ...
            //act
            product.Edit("edited", new Money(1000000),"dsdsds");
        ...
        public void Edit_Should_Throw_NullOrEmptyException_When_Title_Is_Null()
        {
            ...
            var action = new Action(() =>
        {
            product.Edit("", new Money(10000000),"ssf");
        });
        ...
        [Fact]
        public void AddImage_Should_Add_New_Image_To_Products()
        {
            //arrange
            var product = _productBuilder.SetTitle("test2").SetMoney(1000).Build();
        ...
        [Fact]
        public void RemoveImage_Should_Remove_Image_When_Image_Exists()
        {
            //arrange
            var product = _productBuilder.SetTitle("test2").SetMoney(1000).Build();
            product.AddImage("test.png");
        ...
        [Fact]
        public void RemoveImage_Should_Throw_NullOrEmptyException_When_Image_Not_Exists()
        {
            //arrange
            var product = _productBuilder.SetTitle("test2").SetMoney(1000).Build();
